...
namespace ComfyUICaptioningTool.ViewModels.Windows
{
    /// <summary>
    /// メインウィンドウの ViewModel。
    ...
    public partial class MainWindowViewModel : ObservableObject
    {
        ...
        [ObservableProperty]
        private string _applicationTitle = "ComfyUICaptioningTool";
        ...
        private void BuildMenuItems()
        {
            MenuItems = new ObservableCollection<object>
            {
                ...
                {
                    Content = LocalizationManager.Instance["MainWindow_MenuHome"],
