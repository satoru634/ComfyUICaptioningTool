...
namespace ComfyUICaptioningToolTests.ViewModels.Windows
{
    public class MainWindowViewModelTests : IDisposable
    {
        ...
        public void MenuItems_Contains_HomeItem()
        {
            RunOnSta(() =>
            {
                ...
                Assert.Contains(items, item => item.Content?.ToString() == LocalizationManager.Instance["MainWindow_MenuHome"]);
            });
        }
        ...
        public void MenuItems_Contains_DataItem()
        {
            RunOnSta(() =>
            {
                ...
                var items = vm.MenuItems.OfType<NavigationViewItem>().ToList();
                Assert.Contains(items, item => item.Content?.ToString() == LocalizationManager.Instance["MainWindow_MenuData"]);
            });
        }
        ...
        public void MenuItems_HomeItem_TargetPage_IsMainPage()
        {
            RunOnSta(() =>
            {
                ...
                var home = vm.MenuItems.OfType<NavigationViewItem>()
                    .FirstOrDefault(item => item.Content?.ToString() == LocalizationManager.Instance["MainWindow_MenuHome"]);

                Assert.Equal(typeof(MainPage), home?.TargetPageType);
            });
        }
        ...
        public void MenuItems_DataItem_TargetPage_IsDataPage()
        {
            RunOnSta(() =>
            {
                ...
                var data = vm.MenuItems.OfType<NavigationViewItem>()
                    .FirstOrDefault(item => item.Content?.ToString() == LocalizationManager.Instance["MainWindow_MenuData"]);
